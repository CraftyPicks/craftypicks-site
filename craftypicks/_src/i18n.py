...
"foot_stamp":   {"en": "Picks posted {v} ET",
    ...
    "nfl_base":      {"en": "per game", "es": "por partido"},
    "nfl_defence":   {"en": "Defence", "es": "Defensa"},
    "nfl_allows":    {"en": "{opp} allow", "es": "{opp} permite"},
    "nfl_league":    {"en": "league average", "es": "promedio de la liga"},
    "nfl_clears":    {"en": "over {v}", "es": "sobre {v}"},
    "nfl_scored":    {"en": "scored", "es": "anotó"},
    "nfl_detail":    {"en": "Player detail +", "es": "Detalle del jugador +"},
